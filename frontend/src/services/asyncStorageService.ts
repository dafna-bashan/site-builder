...
async function query(entityType: string, filterBy?: object): Promise<Item[]> {
...
async function get(entityType: string, entityId: string): Promise<Item> {
...
async function post(entityType: string, newEntity: Item): Promise<Item> {
...
async function put(entityType: string, updatedEntity : Item): Promise<Item> {
    const entities = await query(entityType)
...
function _save(entityType: string, entities : Item[]) {
